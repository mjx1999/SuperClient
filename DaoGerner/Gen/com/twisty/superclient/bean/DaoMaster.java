...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        MasterDataDao.createTable(db, ifNotExists);
        Detail1DataDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        MasterDataDao.dropTable(db, ifExists);
        Detail1DataDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MasterDataDao.class);
        registerDaoClass(Detail1DataDao.class);
    }
