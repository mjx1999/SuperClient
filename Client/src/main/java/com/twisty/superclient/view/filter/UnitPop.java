...
import com.twisty.superclient.adapter.UnitAdapter;
...
public class UnitPop extends PopupWindow {
    ...
    UnitPop.onItemClickListener itemClickListener;
    public UnitPop(Context context, List<Unit> data, UnitPop.onItemClickListener itemClickListener) {
...
//        this.setWidth(100);
        ...
        final UnitAdapter adapter = new UnitAdapter(context,data);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                UnitPop.this.itemClickListener.onItemClick((Unit) adapterView.getItemAtPosition(i));
