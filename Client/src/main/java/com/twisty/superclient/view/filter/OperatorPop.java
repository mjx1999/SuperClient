 ...
 */
public class OperatorPop extends PopupWindow {

    OperatorPop.onItemClickListener itemClickListener;
    public OperatorPop(Context context, List<Operator> data, OperatorPop.onItemClickListener itemClickListener) {
...
//        this.setWidth(100);
        ...
        final OperatorAdapter adapter = new OperatorAdapter(context,data);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                OperatorPop.this.itemClickListener.onItemClick((Operator) adapterView.getItemAtPosition(i));
                OperatorPop.this.dismiss();
            }
        });
    }
