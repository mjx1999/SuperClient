 ...
 */
public class PayMethodPop extends PopupWindow {

    PayMethodPop.onItemClickListener itemClickListener;
    public PayMethodPop(Context context, List<PayMethod> data, PayMethodPop.onItemClickListener itemClickListener) {
...
//        this.setWidth(100);
        ...
        final PayMethodAdapter adapter = new PayMethodAdapter(context,data);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                PayMethodPop.this.itemClickListener.onItemClick((PayMethod) adapterView.getItemAtPosition(i));
