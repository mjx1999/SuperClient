...
public class TraderDao extends AbstractDao<Trader, Void> {
    ...
    protected void bindValues(SQLiteStatement stmt, Trader entity) {
        ...
        Integer Lev = entity.getLev();
        if (Lev != null) {
            stmt.bindLong(10, Lev);
        }
    ...
    public Trader readEntity(Cursor cursor, int offset) {
        Trader entity = new Trader( //
                ...
                cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9), // Lev
    ...
    public void readEntity(Cursor cursor, Trader entity, int offset) {
        ...
        entity.setLev(cursor.isNull(offset + 9) ? null : cursor.getInt(offset + 9));
    ...
    public static class Properties {
        ...
        public final static Property Lev = new Property(9, Integer.class, "Lev", false, "LEV");
