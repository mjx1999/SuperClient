...
public class UnitDao extends AbstractDao<Unit, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Rate = new Property(4, Float.class, "Rate", false, "RATE");
    ...
    public Unit readEntity(Cursor cursor, int offset) {
        Unit entity = new Unit( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getFloat(offset + 4), // Rate
    ...
    public void readEntity(Cursor cursor, Unit entity, int offset) {
        ...
        entity.setRate(cursor.isNull(offset + 4) ? null : cursor.getFloat(offset + 4));
