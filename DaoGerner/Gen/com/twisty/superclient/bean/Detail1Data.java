...
public class Detail1Data implements java.io.Serializable {
    ...
    public Detail1Data(Long BillID, Integer ItemNO, Double APrice, Double Amount, Long BReferID, Double Disc, Double DiscAmt, Long GoodsID, Double GoodsAmt, Integer IsLargess, Double OrigPrice, Double OrigTaxPrice, Double Quantity, String ReferBillCode, Long ReferBillID, Integer ReferBillType, Integer ReferItemNo, Long StoreID, Double TaxAmt, Double TaxPrice, Double TaxRate, Long UnitID, Double UnitPrice, Double UnitQuantity, Double UnitRate, String UserDef1, String UserDef2, String UserDef3, String UserDef4, String UserDef5, String UserDef6, String UserDef7, String UserDef8, String UserDef9, String UserDef10) {
        this.BillID = BillID;
        this.ItemNO = ItemNO;
        this.APrice = APrice;
        this.Amount = Amount;
